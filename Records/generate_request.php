...
<div class="flex-1 flex items-center justify-center ml-64 top-0 p-6">
    <div class="w-full max-w-6xl bg-white border border-gray-300 rounded-lg shadow-lg p-6">
        <form action="#" method="POST" class="space-y-6">
            <!-- Form Title -->
            <h1 class="text-3xl font-bold text-gray-800 mb-6 text-center">Request Form</h1>
            ...
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="price" placeholder="Enter Price" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                </div>
            </div>
            ...
            <div>
                ...
                <textarea id="specs" name="specs" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Enter Specs" rows="4" style="resize: none;"></textarea>
            </div>

            <!-- Submit Button -->
            <div>
                <button type="submit" class="w-full py-2 bg-blue-500 text-white font-bold rounded-md hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500">
                    Submit Form
                </button>
            </div>
        </form>
