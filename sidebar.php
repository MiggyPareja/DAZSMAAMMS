...
<body class="bg-cover bg-center h-screen"
    ...
    <nav class="flex flex-col space-y-4">
        <?php if ($role == 'Admin'): ?>
            ...
            <div id="recordsMenu" class="hidden flex flex-col p-2 space-y-3">
                ...
                <a href="../Records/add_assets.php">
                    <button class="far fa-circle nav-icon text-white text-xs"> Inventory</button>
                </a>
                <a href="../Records/deployed_assets.php">
                    <button class="far fa-circle nav-icon text-white text-xs"> Deployed Assets</button>
                </a>
                <a href="../Records/disposedAssets.php">
                    <button class="far fa-circle nav-icon text-white text-xs"> Disposed Assets</button>
                </a>
                <a href="../dashboard.php">
                    <button class="far fa-circle nav-icon text-white text-xs"> Transfer Assets(Under Construction)</button>
                </a>
            </div>
            <a>
                <button id="recordsBtn" class="nav-icon fas fa-folder text-white text-sm"> Logs-NotWorking
                    <span id="arrow" class="transform transition-transform">&#9660;</span>
                </button>
            </a>
            <div id="logsMenu" class="hidden flex flex-col p-2 space-y-3">
                <a href="../Records/generate_request.php">
                    <button class="far fa-circle nav-icon text-white text-xs"> Activity Logs</button>
                </a>
                <a href="../Records/generate_request.php">
                    <button class="far fa-circle nav-icon text-white text-xs"> Transfer Logs</button>
                </a>
            </div>
        ...
        <?php elseif ($role == 'Inspector'): ?>
            ...
            <a href="../Records/deployed_assets.php">
                <button class="far fa-circle nav-icon text-white text-sm"> Deployed Assets</button>
            </a>
            <a href="../logout.php" onclick="confirmLogout(event)">
                <button class="nav-icon fas fa-sign-out-alt text-white text-sm"> Log Out</button>
            </a>
